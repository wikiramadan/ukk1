    ...
    <form role="form" method="post" action="proseshitung.php">
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <input type="number" class="form-control" id="HargaBarang" name="harga_barang"
        ...
        <div class="form-group">
          ...
          <input type="number" class="form-control" id="PersentaseDiskon" name="persentase_diskon"
            placeholder="Masukan Persentase Diskon" min="1" max="100">
        </div>
        <div class="form-group">
